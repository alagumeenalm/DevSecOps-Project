...
public class DriverControllerTest {
    ...
    public void findDriver() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/v1/drivers/1")
    ...
    public void findDriversFilteringByUsername() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/v1/drivers?username=user02")
                .accept(MediaType.APPLICATION_JSON);
    ...
    public void findDriversFilteringByOnlineStatusOnline() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/v1/drivers?onlineStatus=ONLINE")
                .accept(MediaType.APPLICATION_JSON);
    ...
    public void findDriversFilteringByOnlineStatusOffline() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.get("/v1/drivers?onlineStatus=OFFLINE")
                .accept(MediaType.APPLICATION_JSON);
    ...
    public void selectCar() throws Exception {
        Mockito.when(driverService.find(1L)).thenReturn(mockDriver);
        Mockito.when(carService.find("5432PW")).thenReturn(mockCarResult);

        RequestBuilder requestBuilder = MockMvcRequestBuilders.put("/v1/drivers/1/car/5432PW")
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON);
    ...
    public void deselectCar() throws Exception {
        ...
        RequestBuilder requestBuilder = MockMvcRequestBuilders.delete("/v1/drivers/1/car/5432PW")
                .accept(MediaType.APPLICATION_JSON)
                .contentType(MediaType.APPLICATION_JSON);
